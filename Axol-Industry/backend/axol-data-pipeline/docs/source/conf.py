...
# axol_data_pipeline documentation build
...
from axol_data_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "axol_data_pipeline"
author = "Kedro"
...
htmlhelp_basename = "axol_data_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "axol_data_pipeline.tex",
        "axol_data_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "axol_data_pipeline",
        "Project axol_data_pipeline codebase.",
        "Data-Science",
    )
]
